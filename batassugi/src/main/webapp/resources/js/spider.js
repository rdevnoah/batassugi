...
var $closeSide = $('#closeSide'), 
	...
	$postListA = $('.postList a'), $like = $('.like a'),
	$rentForm = $('#rentForm'), $rent = $('.rent button'),
...
$rentForm.on('submit', function() {
	...
	BootstrapDialog.confirm({
		...
		onhidden : function() {
			$rentForm.attr('onsubmit',
					[ flag == 'true' ? 'return true;' : 'return false;' ]) // flag가 true면 return ture; false면 return false;
			.submit(); // submit 전송
		},
