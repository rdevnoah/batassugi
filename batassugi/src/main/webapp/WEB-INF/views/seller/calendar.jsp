...
<div class="modal fade" id="createScheduleModal" role="dialog">
	<div class="modal-dialog">
		<form id="registerForm" action='${pageContext.request.contextPath}/seller/createSchedule' method="post" onsubmit="return false;">
				<!-- Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body">									
					<div class="form-group">
						...
						<input type="text" class="form-control" value="필수일정" readonly="readonly">
