...
public class ScheduleController {
   ...
   * @return
   */
  @RequestMapping(method = {RequestMethod.POST, RequestMethod.GET}, value = "seller/createSchedule")
   ...
   * @return
   */
  @RequestMapping(method = {RequestMethod.POST, RequestMethod.GET}, value = "buyer/createSchedule")
